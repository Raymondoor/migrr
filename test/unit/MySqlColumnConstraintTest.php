...
class MySqlColumnConstraintTest extends TestCase
{
    private MySqlColumnConstraint $constraint;
    private MySqlSchema $schema;

    protected function setUp(): void
    {
        $this->schema = new MySqlSchema();
        $this->constraint = new MySqlColumnConstraint($this->schema, 'id ');
    }
    ...
    public function test_identity_appends_auto_increment(): void
    {
        $result = $this->constraint->identity();
        $this->assertSame($this->constraint, $result);
        $this->assertStringContainsString('AUTO_INCREMENT', $this->constraint->columnDef);
    }
