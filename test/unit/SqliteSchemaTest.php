...
class SqliteSchemaTest extends TestCase
{
    ...
    {
        $this->assertEquals('sqlite', $this->schema->driver);
    ...
    public function test_raw_appends_sql_with_space(): void
    {
        $this->schema->create_table('users');
        $result = $this->schema->raw('ADD COLUMN email');
        $this->assertSame($this->schema, $result);
    ...
    public function test_columns_returns_column_name_instance(): void
    {
        ...
        $this->assertInstanceOf(SqliteColumnName::class, $columnName);
    ...
    public function test_full_create_table_workflow(): void
    {
        ...
        $this->assertStringContainsString('INTEGER PRIMARY KEY', $this->schema->query);
